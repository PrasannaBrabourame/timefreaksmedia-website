                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse main-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item"><a class="nav-link page-scroll" href="/services.html">Service -
                                        Digital Media</a></li>
                                <li class="nav-item"><a class="nav-link page-scroll" href="/technology.html">Technology
                                        Services</a></li>
